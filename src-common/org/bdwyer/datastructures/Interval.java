...
public class Interval implements Comparable< Interval > {
	...
	/**
	 * Tests whether the input interval overlaps this interval. Adjacency does not count
	 * as overlapping.
	 */
	public boolean isOverlap( Interval interval ) {
		if ( interval.start >= this.end ) return false;
		if ( this.start >= interval.end ) return false;
		return true;
	}
